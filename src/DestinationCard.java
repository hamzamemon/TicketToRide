...
/**
 * Enum to store the destination cards. Names are the start
 * city, followed by the end city. Each Destination Card enum
 * object has a start city, end city, and a point value for 
 * trading in that card.
 *
 * @author Josh Dratler
 * @author Hamza Memon
...
public enum DestinationCard {
    ...
    private final City extraCity;
    /**
     * Contstructor for Destination Cards. The user is able to set the 
     * desired start city, desired end city, and the value of the card
     * when traded in.
     * 
    ...
    /**
     * Method to get the start city of the destination card
     * 
     * @return the start city of the destination card.
     */
    ...
    /**
     * Method to get the end city of the destination card
     * 
     * @return the end city of the destination card.
     */
    public City getEnd(){
        return end;
    }
    ...
    /**
     * Method to get the value of the destination card
     * 
     * @return the value of the destination card.
     */
