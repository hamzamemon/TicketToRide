...
public enum Route {
    ...
    INVERNESS_ULLAPOOL("S", City.INVERNESS, City.ULLAPOOL, new int[]{424, 432, 419, 411}, new int[]{117, 113, 89, 93}, Color.ORANGE, 1, 0),
    ...
    /**
     * Initializes a polygon based on the x and y coordinates, and initializes parameters below
     *
    ...
    public static void setUpDoubleRoutes() {
        SOUTHAMPTON_LONDON_1.doubleRoute = SOUTHAMPTON_LONDON_2;
        SOUTHAMPTON_LONDON_2.doubleRoute = SOUTHAMPTON_LONDON_1;
        LONDON_NORTHAMPTON_2.doubleRoute = LONDON_NORTHAMPTON_1;
        LONDON_NORTHAMPTON_1.doubleRoute = LONDON_NORTHAMPTON_2;
        LONDON_CAMBRIDGE_1.doubleRoute = LONDON_CAMBRIDGE_2;
        LONDON_CAMBRIDGE_2.doubleRoute = LONDON_CAMBRIDGE_1;
        BIRMINGHAM_NORTHAMPTON_2.doubleRoute = BIRMINGHAM_NORTHAMPTON_1;
        BIRMINGHAM_NORTHAMPTON_1.doubleRoute = BIRMINGHAM_NORTHAMPTON_2;
        LEEDS_MANCHESTER_1.doubleRoute = LEEDS_MANCHESTER_2;
        LEEDS_MANCHESTER_2.doubleRoute = LEEDS_MANCHESTER_1;
        LIVERPOOL_MANCHESTER_2.doubleRoute = LIVERPOOL_MANCHESTER_1;
        LIVERPOOL_MANCHESTER_1.doubleRoute = LIVERPOOL_MANCHESTER_2;
        BIRMINGHAM_MANCHESTER_1.doubleRoute = BIRMINGHAM_MANCHESTER_2;
        BIRMINGHAM_MANCHESTER_2.doubleRoute = BIRMINGHAM_MANCHESTER_1;
        NEWCASTLE_LEEDS_1.doubleRoute = NEWCASTLE_LEEDS_2;
        NEWCASTLE_LEEDS_2.doubleRoute = NEWCASTLE_LEEDS_1;
        GALWAY_TULLAMORE_2.doubleRoute = GALWAY_TULLAMORE_1;
        GALWAY_TULLAMORE_1.doubleRoute = GALWAY_TULLAMORE_2;
        SOUTHAMPTON_FRANCE_1.doubleRoute = SOUTHAMPTON_FRANCE_2;
        SOUTHAMPTON_FRANCE_2.doubleRoute = SOUTHAMPTON_FRANCE_1;
        TULLAMORE_DUBLIN_1.doubleRoute = TULLAMORE_DUBLIN_2;
        TULLAMORE_DUBLIN_2.doubleRoute = TULLAMORE_DUBLIN_1;
        ROSSLARE_DUBLIN_1.doubleRoute = ROSSLARE_DUBLIN_2;
        ROSSLARE_DUBLIN_2.doubleRoute = ROSSLARE_DUBLIN_1;
        DUBLIN_DUNDALK_2.doubleRoute = DUBLIN_DUNDALK_1;
        DUBLIN_DUNDALK_1.doubleRoute = DUBLIN_DUNDALK_2;
        DUNDALK_BELFAST_2.doubleRoute = DUNDALK_BELFAST_1;
        DUNDALK_BELFAST_1.doubleRoute = DUNDALK_BELFAST_2;
        NEWCASTLE_EDINBURGH_2.doubleRoute = NEWCASTLE_EDINBURGH_1;
        NEWCASTLE_EDINBURGH_1.doubleRoute = NEWCASTLE_EDINBURGH_2;
        GLASGOW_EDINBURGH_1.doubleRoute = GLASGOW_EDINBURGH_2;
        GLASGOW_EDINBURGH_2.doubleRoute = GLASGOW_EDINBURGH_1;
        BIRMINGHAM_CARDIFF_1.doubleRoute = BIRMINGHAM_CARDIFF_2;
        BIRMINGHAM_CARDIFF_2.doubleRoute = BIRMINGHAM_CARDIFF_1;
    }
    
    /**
     * Retrieves the country of the route
     *
    ...
    /**
     * Retrieves the start city of the route
     *
    ...
    /**
     * Retrieves the end city of the route
     *
    ...
    /**
     * Retrieves the color of the route
     *
    ...
    /**
     * Retrieves the number of ferries required for that route
     *
     * @return number of ferries for that route
     */
    public int getFerry() {
        return ferry;
    }
    ...
    /**
     * Retrieves the length of the route
     *
    ...
    /**
     * Retrieves the Polygon of the route to draw
     *
    ...
    /**
     * Checks to see if a route has been claimed
     *
     * @return true if a route has been claimed, false if it has not been claimed.
     */
    ...
    /**
     * Retrieves the player we are currently looking at
     *
    ...
    /**
     * Set the player being looked at.
     *
    ...
    /**
     * Determines the point value of the routes (based on their length)
     *
    ...
    /**
     * Retrieves the corresponding route
     *
